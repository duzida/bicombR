# get Pubmed abstract from eutils 

## 1.set class
setClass("eutils", solts = list(host = "character", db = "character", retmax = "character", api_key = "character", 
                                rettype = "character", retmode = "character", email = "character", tool = "character"), 
         prototype = list(db = "pubmed", retmode = "xml", email = "gerhard.schofl%40gmail.com", tool = "reutils", api = "a199b97228d17a42d7eeb4835a826ba27f08"))

setClass("search", contains = "eutils", solts = list(term = "character"), 
         prototype = list(host = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi", 
                          name = "esearch", rettype = "count", retmax = "100"))

setClass("fetch", contains="eutils", solts = list(id = "character"), 
